...
from doc_aggregator.utils.files import ScannedFile, scan_supported_files, validate_file_unchanged
...
class DocumentAggregator:
    ...
    def scan_and_validate(self, manifest: ManifestStore) -> list[ManifestRecord]:
        scanned = scan_supported_files(self.input_dir, self.config, self.logger)
    ...
    def dry_run(self) -> None:
        ...
        self.logger.info("Discovered supported files: %d", len(records))
